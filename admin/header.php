                                    ...
                                    <div class="topbar-item">
                                        <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                            ...
                                            */ ?>
                                            ...
                                            <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">أشرف نصر علي</span>
                                            <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"> </span>
                                            <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">آخر دخول لك كان في 16/09/2022 10:23 </span>
                                        </div>
                                    </div>
                                    <!--end::User-->
                                    <!--begin::Languages-->
